...
class NFLDataMCPServer {
  ...
  private dataManager: NFLDataManager;
  ...
  private async handleGetPlayerStats(args: any): Promise<CallToolResult> {
  ...
  private async handleComparePlayers(args: any): Promise<CallToolResult> {
  ...
  private async handleGetPositionLeaders(args: any): Promise<CallToolResult> {
  ...
  private async handleSearchPlayers(args: any): Promise<CallToolResult> {
